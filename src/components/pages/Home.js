...
export default function Home() {
  return (
    ...
    >
      ...
      <a href="https://docs.google.com/document/d/1liyCcq_EasESWtMTfsrcsYcqI-m5U1Nc/edit?usp=sharing&ouid=110244157607918638497&rtpof=true&sd=true">
        <Image
          src={require("./../../assets/img/waldo.png")}
          alt="Github"
          width={480}
          href="https://docs.google.com/document/d/1liyCcq_EasESWtMTfsrcsYcqI-m5U1Nc/edit?usp=sharing&ouid=110244157607918638497&rtpof=true&sd=true"
          height={480}
      ...
      <div>
        ...
        <h4>
          Description: With the use of weather map APIs, we are able to display
        ...
        <h1>Fetch API's</h1>
        <h4>
          Description: With the use of 3 APIs, we can provide users with
        ...
        <h4>
          Description: Creates application that enables users to generate random
        ...
        <h4>
          Description: CMS-style blog site similar to a Wordpress site, where
